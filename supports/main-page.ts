...
constructor(page: Page){
    ...
    this.accept_cookie_btn = page.getByText('I DO NOT AGREE')
    this.reject_cookie_btn = page.getByText('I AGREE, I WANT TO GO TO THE')
...
async verivy_cookie_container_invisible(){
    expect(this.cookie_container).toBeHidden();
}
